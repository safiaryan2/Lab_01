...
public class PlayerController : MonoBehaviour {
	...
	void FixedUpdate () {
        ...
        //float moveHoriz1 = Input.GetAxis("Horizontal1");

        //// Pass horizontal velocity to animator (SPEED)
        //animator.SetFloat("Speed", Mathf.Abs(moveHoriz1));

        //// Debug.Log("Move Horizontal: " + moveHoriz);
        //rBody.velocity = new Vector2(moveHoriz1 * maxSpeed, rBody.velocity.y);

        //if (moveHoriz1 > 0)
        //{
        //    sRend.flipX = false;
        //}
        //else if (moveHoriz1 < 0)
        //{
        //    sRend.flipX = true;
        //}
    }
